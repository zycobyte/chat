...
let server = (window.location.hostname==="localhost"?"ws://localhost":"wss://servers.us-west.eiennochat.co.uk")+":25000/eiennosocket/data";
let dataserver = (window.location.hostname==="localhost"?"ws://localhost":"wss://servers.us-west.eiennochat.co.uk")+":25001/datasocket/data";
...
function handleRecieveDataFromServer(data){
    ...
    // console.log(data);//TODO anything else I add
}
